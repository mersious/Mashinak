 ...
 * string. Highest level first: when you switch to L4 you want the L4 features on top.
 */
export function visibleFeatures(level: Level, q = ''): Feature[] {
  ...
  ).sort((a, b) => b.level - a.level || CAT_ORDER.indexOf(a.category) - CAT_ORDER.indexOf(b.category))
}
