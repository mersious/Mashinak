  ...
  return (
    <>
      <header className="top">
        <div className="brand">
          <h1>Mashinak</h1>
          <p>What a car does for its driver, layer by layer, from L0 to L5.</p>
        </div>
        <LevelSelector level={level} onChange={setLevel} />
      </header>
      <main>
        <aside className="carpane">
          <CarView sensors={feature?.sensors ?? []} actuators={feature?.actuators ?? []} highlight={feature !== null} />
          <div className="legend">
            <span className="kind-camera">camera</span>
            <span className="kind-radar">radar</span>
            <span className="kind-ultra">ultrasonic</span>
            <span className="kind-lidar">lidar</span>
            <span className="kind-gnss">GNSS</span>
            <span className="kind-driver">driver cam</span>
            <span className="kind-chassis">chassis</span>
            <span className="kind-act">actuator</span>
          </div>
        </aside>
      ...
      <footer>
        Levels follow SAE J3016. Feature names are generic; brand names appear as aliases. Corrections welcome on GitHub.
      </footer>
    </>
  )
}
